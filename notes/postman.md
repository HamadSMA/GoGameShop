...
Each saved request, folder, and environment lives as a YAML/JSON file under `postman/`, committed to the repo if you choose to share them, or gitignored for personal use.
