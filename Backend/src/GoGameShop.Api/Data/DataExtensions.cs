        ...
        if (!dbContext.Games.Any())
        {
            ...
            dbContext.Games.AddRange(
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/1190460/library_600x900.jpg",
                    Genre = adventure,
                    Rating = mature,
                    LastUpdatedBy = "seed"
                },
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/1659420/library_600x900.jpg",
                    Genre = adventure,
                    Rating = teen,
                    LastUpdatedBy = "seed"
                },
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/289070/library_600x900.jpg",
                    Genre = strategy,
                    Rating = everyone,
                    LastUpdatedBy = "seed"
                },
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/2195250/library_600x900.jpg",
                    Genre = sports,
                    Rating = everyone,
                    LastUpdatedBy = "seed"
                },
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/1794960/library_600x900.jpg",
                    Genre = fighting,
                    Rating = teen,
                    LastUpdatedBy = "seed"
                },
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/1466860/library_600x900.jpg",
                    Genre = strategy,
                    Rating = teen,
                    LastUpdatedBy = "seed"
                },
                ...
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/2338770/library_600x900.jpg",
                    Genre = sports,
                    Rating = everyone,
                    LastUpdatedBy = "seed"
                },
                new Game
                {
                    ...
                    ImageUri =
                        "https://cdn.cloudflare.steamstatic.com/steam/apps/1147940/library_600x900.jpg",
                    Genre = puzzle,
                    Rating = everyone,
                    LastUpdatedBy = "seed"
                }
